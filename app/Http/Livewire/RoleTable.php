    ...
    */
    public function addColumns(): PowerGridColumns
    {
        return PowerGrid::columns()
            ...
            ->addColumn('created_at_formatted', fn (Role $model) => Carbon::parse($model->created_at)->toDayDateTimeString());
    }
    ...
    public function actions(): array
    {
        return [
            Button::make('edit', '
                ...
                ->openModal('edit-role-modal', ['role' => 'id']),
            ...
            Button::make('Delete', '
                ...
                ->method('delete')
                ->openModal('delete-role-modal', ['role' => 'id']),
        ];
    }
