    ...
    */
    public function addColumns(): PowerGridColumns
    {
        return PowerGrid::columns()
            ...
            ->addColumn('created_at_formatted', fn (Permission $model) => Carbon::parse($model->created_at)->toDayDateTimeString());
    }
    ...
    public function actions(): array
    {
        return [
            Button::make('edit', '
                ...
                ->openModal('edit-permission-modal', ['permission' => 'id']),
            ...
            Button::make('Delete', '
                ...
                ->method('delete')
                ->openModal('delete-permission-modal', ['permission' => 'id']),
        ];
    }
