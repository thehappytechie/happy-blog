<div class="relative" x-data="{ open: false }">
    ...
    <div x-show="open" @click.outside="open = false"
        ...
        <a href="#" class="divide-y divide-gray-100 block px-3 py-1 text-sm leading-6 text-gray-900" role="menuitem" tabindex="-1"
            id="user-menu-item-0">Your password</a>
            <div class="border-t border-gray-100"></div>
        <a href="#" class="block px-3 py-1 text-sm leading-6 text-gray-900" role="menuitem" tabindex="-1"
            id="user-menu-item-0">Settings</a>
        <a href="#" class="block px-3 py-1 text-sm leading-6 text-gray-900" role="menuitem" tabindex="-1"
            id="user-menu-item-1">Sign
            out</a>
    </div>
</div>
