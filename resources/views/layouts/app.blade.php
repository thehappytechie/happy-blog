...
<head>
    ...
    <link
        ...
        rel="stylesheet" />
    <link href="https://cdn.jsdelivr.net/npm/tom-select@2.2.2/dist/css/tom-select.bootstrap5.css"
        rel="stylesheet">
                    ...
                    <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4">
                        ...
                        <nav class="flex flex-1 flex-col">
                            <ul role="list" class="flex flex-1 flex-col gap-y-7">
                                ...
                                <li>
                                    <div class="text-xs font-semibold leading-6 text-gray-400">Your
                                        teams</div>
        ...
        <div class="lg:pl-72">
            ...
            <main class="py-5">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div
                        class="relative h-[640px] overflow-auto rounded-xl border border-solid border-gray-300 opacity-75 shadow-sm mt-5">
