<div>
    <div class="bg-white px-8 py-6">
        <h2 class="text-2xl sm:text-2xl font-medium font-display text-gray-800 tracking-tight mb-5">Add Category
        </h2>
    ...
    <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
        <button wire:click.prevent="save"
            class="inline-flex w-full justify-center rounded-md bg-purple-600 px-12 py-2 text-xs font-semibold text-white shadow-sm hover:bg-purple-600 sm:ml-3 sm:w-auto">Save</button>
        <button wire:click.prevent="$emit('closeModal')"
            class="mt-3 inline-flex w-full justify-center rounded-md bg-white px-5 py-2 text-xs font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto">Close</button>
    </div>
</div>
