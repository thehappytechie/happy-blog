    ...
    <div class="bg-white px-5 py-5">
        ...
        <form class="border-t border-gray-100" method="POST">
            <div class="grid gap-5 grid-cols-2 md:grid-cols-2 mt-4 mb-2">
                ...
                <div>
                    <label for="slug"
                        class="block text-sm font-medium leading-6 text-gray-700">Email <span class="text-pink-700 text-xs">*</span></label>
            ...
            <div class="grid gap-5 grid-cols-2 md:grid-cols-2 mt-4 mb-2">
                <div>
                    <label for="name"
                        class="block text-sm font-medium leading-6 text-gray-700">Password
                        <span class="text-pink-700 text-xs">*</span></label>
                    <div class="mt-2">
                        <input type="text" id="name" wire:model="name"
                ...
                <div>
                    <label for="slug"
                        class="block text-sm font-medium leading-6 text-gray-700">Confirm password <span class="text-pink-700 text-xs">*</span></label>
                    <div class="mt-2" wire:ignore>
                        <input type="text" id="slug" wire:model="slug" class="input__field"
                            disabled>
                    </div>
