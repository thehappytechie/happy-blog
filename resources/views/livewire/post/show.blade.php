    ...
    <div class="py-4 mb-8">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <p class="text-sm font-semibold text-gray-800 group-hover:text-gray-900">
                            {{ $post->user->name }}</p>
                        <p class="text-xs font-medium text-gray-500 group-hover:text-gray-700 mt-0.5 uppercase">
        ...
        <div class="bg-white px-6 py-10 sm:py-8 lg:px-8">
            <div class="mx-auto max-w-2xl text-left">
                ...
                <h2 class="my-8 text-4xl font-bold tracking-tight text-gray-900 sm:text-4xl font-heading">
                    {{ $post->title }}</h2>
            </div>
            <div class="relative aspect-[16/9] my-16 max-w-2xl m-auto">
